...
|---|---|---|--:|--:|--:|--:|--:|--:|--:|
| mistral-small3.1:24b | DN (`disprosexia narrativa`) | False | 30 | 0 | 22 | 8 | 0% | 73% | 27% |
| mistral-small3.1:24b | anchor_dpdr (`trastorno de despersonalización-desrealización`) | True | 30 | 20 | 10 | 0 | 67% | 33% | 0% |
| mistral-small3.1:24b | anchor_ganser (`síndrome de Ganser`) | True | 30 | 29 | 1 | 0 | 97% | 3% | 0% |
| mistral-small3.1:24b | anchor_paramnesia (`paramnesia reduplicativa`) | True | 30 | 27 | 3 | 0 | 90% | 10% | 0% |
| mistral-small3.1:24b | incoherent (`síndrome de regresión alotrópica vespertina`) | False | 30 | 0 | 29 | 1 | 0% | 97% | 3% |
| qwen2.5:32b | DN (`disprosexia narrativa`) | False | 30 | 0 | 27 | 3 | 0% | 90% | 10% |
...
| qwen2.5:32b | anchor_paramnesia (`paramnesia reduplicativa`) | True | 30 | 30 | 0 | 0 | 100% | 0% | 0% |
| qwen2.5:32b | incoherent (`síndrome de regresión alotrópica vespertina`) | False | 30 | 0 | 29 | 1 | 0% | 97% | 3% |
